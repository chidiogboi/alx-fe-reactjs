function UserProfile() {
  return (
    <div className="bg-gray-100 p-4 sm:p-4 md:p-8 max-w-xs sm:max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg">
      ...
      />
      <h1 className="text-lg sm:text-lg md:text-xl text-blue-800 my-4 text-center">chidiogboi</h1>
      <p className="text-gray-600 text-sm sm:text-sm md:text-base text-center">
        Developer at ogboichidi. Loves to write code and explore new technologies.
      </p>
    </div>
  );
}
